...
import NewspaperLocation from "../assets/client-location.png";
...
function NewspaperDetails() {
  ...
  useEffect(() => {
    const tempName = localStorage.getItem("hoveredNewspaper");
    ...
    // Note: Make sure data, setData, and oneNewspaper are properly defined in your component
  }, []);
